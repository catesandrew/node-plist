;(function (exports, DOMParser, xmlbuilder) {
  ...
  // If the value of a variable is an integer, then the numeric value of it's
  // parseFloat() and parseInt() equivalents will be the same, so:
    ...
    //Object
      ...
      for(var prop in obj) {
        if(obj.hasOwnProperty(prop)) {
          if (prop === 'IMAGE') {
            r+='\n<key>'+encodeXML(prop)+'</key><data>'+obj[prop]+'</data>';
          } else {
